# -*- coding: utf-8 -*-
"""wav2vec_layer_9 (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NMfukxXC9gsDcFpCCWLgIs2lbhibKKQB
...
def perform_random_search(model, param_distribution, X_train, y_train):
    ...
    random_search = RandomizedSearchCV(estimator=model, param_distributions=param_distribution, scoring='accuracy', n_iter=2, cv=2, n_jobs=-1, verbose=2)
